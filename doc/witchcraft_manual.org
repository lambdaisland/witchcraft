...
Find the latest release [[https://github.com/lambdaisland/witchcraft-plugin/releases/tag/v0.0.14][here]], and download the plugin that matches the server
