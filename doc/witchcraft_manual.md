...
1.  [Introduction](#org525257b)
2.  [Minecraft Concepts](#org5d2e1e1)
    1.  [Survival vs Creative](#org7f31eec)
    2.  [Whirlwind Tour of a Survival Game](#orgb46d2a6)
    3.  [Worlds and Biomes](#org698826f)
    4.  [Coordinate system](#org5d4a750)
    5.  [The flattening](#orgda96ba6)
    6.  [Resources and Crafting](#org47bd821)
    7.  [Villagers and Traders](#org6ca52db)
    8.  [Farming](#org21e7405)
    9.  [Redstone](#org30c5999)
    10. [Enchanting and XP](#org3599dcf)
    11. [Modding, Bukkit, SpigotMC](#orge2fe210)
    12. [Java vs Bedrock](#orgebd47d2)
    13. [Alternative Games](#org0e6d753)
        1.  [Parkour](#org5d96959)
        2.  [Speedrunner vs Hunters](#org8759836)
        3.  [Skyblock](#org1fdc52e)
        4.  [Build Wars](#org2b01c3d)
        5.  [Bed Wars](#org250f430)
3.  [Getting started with Witchcraft](#org0fcc550)
    1.  [Running the plugin](#org33aa5fb)
    2.  [Running from the REPL](#org44ca1e7)
4.  [Learning to code with Witchcraft](#org8c6ed4a)
5.  [Topics](#org0dbd423)
    1.  [Inspecting the world](#orgdec83a4)
    2.  [Creating blocks](#org393d213)
    3.  [Drawing with Cursor](#orgc9dab07)
    4.  [Adding Event Handlers](#orge3f0bb3)
    5.  [Interacting with Players](#org0216194)
