...
1.  [Introduction](#orgede7cda)
2.  [Minecraft Concepts](#org3b493f7)
    1.  [Survival vs Creative](#org212b4d6)
    2.  [Whirlwind Tour of a Survival Game](#org8f2848c)
    3.  [Worlds and Biomes](#org1ba2e2b)
    4.  [Coordinate system](#org20f5e51)
    5.  [The flattening](#orgc76b80c)
    6.  [Resources and Crafting](#org90279bc)
    7.  [Villagers and Traders](#orgc46efde)
    8.  [Farming](#org951138e)
    9.  [Redstone](#orgaffcae6)
    10. [Enchanting and XP](#org1297a20)
    11. [Modding, Bukkit, SpigotMC](#org2ebabb0)
    12. [Java vs Bedrock](#org2ed2b80)
    13. [Alternative Games](#org29f3bdc)
        1.  [Parkour](#org69d1323)
        2.  [Speedrunner vs Hunters](#org274c8d1)
        3.  [Skyblock](#org6c697bb)
        4.  [Build Wars](#orgce9490d)
        5.  [Bed Wars](#org3f7bf07)
3.  [Getting started with Witchcraft](#org83cce97)
    1.  [Running the plugin](#org7b9b3e4)
    2.  [Running from the REPL](#orge4c9ecf)
4.  [Learning to code with Witchcraft](#orgdd27846)
5.  [Topics](#orgf7803b7)
6.  [Recipes](#org1e9d371)
