...
1.  [Introduction](#orgfc7317f)
2.  [Minecraft Concepts](#orgd99b087)
    1.  [Survival vs Creative](#org3360a3c)
    2.  [Whirlwind Tour of a Survival Game](#org6e17165)
    3.  [Worlds and Biomes](#org07d5213)
    4.  [Coordinate system](#orgf4b0cbc)
    5.  [The flattening](#orgb5288f0)
    6.  [Resources and Crafting](#org7d5e44b)
    7.  [Villagers and Traders](#org3e0b6ff)
    8.  [Farming](#org09ff0d0)
    9.  [Redstone](#org0eeff70)
    10. [Enchanting and XP](#org4eaca05)
    11. [Modding, Bukkit, SpigotMC](#org975e2a9)
    12. [Java vs Bedrock](#orgb2c4416)
    13. [Alternative Games](#org591e22f)
        1.  [Parkour](#orgf0f75a1)
        2.  [Speedrunner vs Hunters](#orgbb90734)
        3.  [Skyblock](#org799f4a4)
        4.  [Build Wars](#orgba7d7b7)
        5.  [Bed Wars](#orgee2c1bb)
3.  [Getting started with Witchcraft](#org8437786)
    1.  [Running the plugin](#orgcf900fd)
    2.  [Running from the REPL](#orgbd802cc)
4.  [Learning to code with Witchcraft](#orgb6984af)
5.  [Topics](#org8a55975)
    1.  [Inspecting the world](#org6abb4b1)
    2.  [Creating blocks](#orgcc2c6ce)
    3.  [Drawing with Cursor](#orgf2211dc)
    4.  [Adding Event Handlers](#orga76ef59)
    5.  [Interacting with Players](#org5e82ba3)
